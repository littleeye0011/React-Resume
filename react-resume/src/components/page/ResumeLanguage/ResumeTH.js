      ...
      <div className="main-container">
        ...
        <div className="EXP">
          ...
          <ul>
            ...
            <li className="h1">
              บริษัท สยามโกลบอลเฮ้าส์ จำกัด (มหาชน) สาขาเชียงราย | กันยายน 2562
              – มกราคม 2563
            </li>
            <ul>
              <li>
            ...
            <li className="h1">
              บริษัท อิชิตัน กรุ๊ป จำกัด (มหาชน) | มกราคม 2563 - ปัจจุบัน
            </li>
            <ul>
              <li>
                <div className="position">ช่างเทคนิค</div>
                <ul>
                  <li>ควบคุม , บำรุงรักษาเครื่องจักร</li>
                </ul>
              </li>
            </ul>
          </ul>
